...
convert_failed_note = "*NOTE: Please Double Check the Order of Color entered, and Re-enter 'convert / convert order_of_color' Command. The Value Should be 'RGB' or 'BGR'."
